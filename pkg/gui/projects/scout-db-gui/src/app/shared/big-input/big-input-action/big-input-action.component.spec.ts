...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<sdbg-big-input-action></sdbg-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<sdbg-big-input-action [disabled]="true"></sdbg-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<sdbg-big-input-action fontSet="fas" fontIcon="trash"></sdbg-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<sdbg-big-input-action label="delete"></sdbg-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<sdbg-big-input-action (action)="actionHandler()"></sdbg-big-input-action>';
    fixture = createHostComponent(template);
